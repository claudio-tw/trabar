...
\newcommand{\Prob}{{{P}}}
\newcommand{\probabilitiesOver}[1]{\mathcal{P}\left({#1}\right)}
...
%Notation for TraBar
\newcommand{\givenFamily}{\mathcal{V}}
\newcommand{\familiyDistribution}{\tau}
\newcommand{\statisticsSpace}{\mathcal{X}}
\newcommand{\statistics}{S}
\newcommand{\pushforwardStat}{\sigma}
\newcommand{\coupling}[1][t]{\nu_{{#1}}}
\newcommand{\baricentre}{\mu}
\newcommand{\bariDistance}{\mathtt{d}}
